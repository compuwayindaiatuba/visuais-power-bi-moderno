...
const categoryLabelLayoutItems = [
    { value: "horizontal", displayName: "Horizontal" },
    { value: "angled", displayName: "Inclinado" }
];
...
class ChartSettings extends FormattingSettingsCard {
    ...
    rowGap = new formattingSettings.NumUpDown({
        name: "rowGap",
        displayName: "Espaco entre categorias",
        value: 12
    });
    ...
    categoryWidth = new formattingSettings.NumUpDown({
        name: "categoryWidth",
        displayName: "Largura por categoria",
        value: 70
    });

    valueWidth = new formattingSettings.NumUpDown({
        name: "valueWidth",
        displayName: "Largura eixo valores",
        value: 56
    });
...
class LabelsSettings extends FormattingSettingsCard {
    ...
    categoryLabelLayout = new formattingSettings.ItemDropdown({
        name: "categoryLabelLayout",
        displayName: "Texto categorias",
        value: { value: "horizontal", displayName: "Horizontal" },
        items: categoryLabelLayoutItems
    });
